...
function GameScreen(){
    ...
    //make a new DOM element : got some fixing to do here to work with the game screen types: Mia, the game screen already exists!
    this.dom_element = document.createElement("div");
    this.dom_element.setAttribute("id", "gameScreen");
